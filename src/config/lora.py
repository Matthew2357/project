...
def parse_args(base_parser: ArgumentParser, args: List[str], namespace: Namespace) -> Namespace:
    ...
    parser.add_argument('--A_init', default='kaiming', type=str, choices=['kaiming', 'orth', 'zero'])
    parser.add_argument('--B_init', default='zero', type=str, choices=['kaiming', 'orth', 'zero'])
    # Distributed args
    ...
    parser.add_argument('--method', type=str, default='homogeneous',choices=['homogeneous', 'hetlora', 'flexlora', 'ffa','ffa_inversed', 'fedavg', 'fedsa_inv', 'fedsa'], help='homogeneous, hetlora, flexlora, ffa, fedavg')
